...
const TourDetails = () => {
   ...
   const submitHandler = async e => {
      ...
      try {
         ...
         toast.info('🙏🏼 We appreciate your review! 😊', {
            position: "top-center",
            autoClose: 3000,
            hideProgressBar: false,
            closeOnClick: true,
                  ...
                  <></>} */}
                        ...
                        <div className="tour__info">
                           ...
                           <div className="d-flex align-items-center gap-5">
                              ...
                              <span><i class='ri-time-line'></i> {address}</span>
                              <span><i class='ri-map-pin-3-line'></i> Pickup point:- {pickUppoint} </span>
                           </div>

                           <div className="tour__extra-details">
                              <span><i class='ri-map-2-line'></i> {city}</span>
